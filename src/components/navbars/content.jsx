...
export default function NavigationMenuDemo() {
  return (
    <NavigationMenu >
      <NavigationMenuList >
        <NavigationMenuItem >
          <NavigationMenuTrigger className="dark:bg-slate-900">Getting started</NavigationMenuTrigger>
          <NavigationMenuContent>
        ...
        <NavigationMenuItem >
          <NavigationMenuTrigger className="dark:bg-slate-900">Components</NavigationMenuTrigger>
          <NavigationMenuContent>
